...
const CartSummary = () => {
  ...
  return (
    <>
      {isLoaded(auth) &&
        (isEmpty(auth) ? (
          <Button onClick={() => dispatch(openModal('RegisterModal'))} className="btn btn-primary">
            Sign-Up
          </Button>
        ) : (
          shoppingCart && (
              ...
              <Dropdown.Menu alignRight>
                <div className="cart-summary">
                  <div className="p-3 text-center border-bottom">
                    <p className="text-uppercase font-family-base mb-0">
                      <small>
                        Complete order by <span className="text-primary">Sunday</span>
                      </small>
                    </p>
                  </div>
                  <div className="p-3">
                  ...
                  <hr className="my-0" />
                  <div className="p-3 text-center">
                    <a href="/cart" className="text-uppercase font-family-base mb-0">
                      <small>
                        <span className="text-primary">View and edit cart</span>
                      </small>
                    </a>
                  </div>
                </div>
