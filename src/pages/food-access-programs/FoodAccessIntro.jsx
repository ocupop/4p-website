      ...
      <div className="container">
        ...
        <div className="row">
            ...
            <div className="row align-items-center mb-4">
              <div className="col-12 col-sm-4 col-lg-12">
                <div className="px-lg-5 ml-auto mx-lg-4 py-lg-4">
                  <img src="/img/icons/homepage-foodaccess-geographic.png" className="img-fluid" alt="" />
                </div>
              </div>
              <div className="col-12 col-sm-7 col-lg-12 text-sm-left text-lg-center">
                <h4 className="text-white">Geographic</h4>
                <p>The geographic access challenge is availability to resources for Good Food. For examples, no grocery stores within a reasonable distance.</p>
              </div>
            </div>
          </div>
          <div className="col-12 col-lg-4 text-center">
            <div className="row align-items-center mb-4">
              <div className="col-12 col-sm-4 col-lg-12">
                <div className="px-lg-5 ml-auto mx-lg-4 py-lg-4">
                  <img src="/img/icons/homepage-foodaccess-financial.png" className="img-fluid" alt="" />
                </div>
              </div>
              <div className="col-12 col-sm-7 col-lg-12 text-sm-left text-lg-center">
          ...
          <div className="col-lg-4 text-center">
            <div className="row align-items-center mb-4">
              <div className="col-12 col-sm-4 col-lg-12">
                <div className="px-lg-5 ml-auto mx-lg-4 py-lg-4">
                  <img src="/img/icons/homepage-foodaccess-personal.png" className="img-fluid" alt="" />
                </div>
              </div>
              <div className="col-12 col-sm-7 col-lg-12 text-sm-left text-lg-center">
        ...
        <div className="row">
          <div className="col-12 text-center">
            <a href="/food-access-programs" className="btn btn-primary mt-5">Learn More This Important Issue</a>
          </div>
        </div>
      </div>
    </section>
